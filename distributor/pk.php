...
if($op=='ambildarah'){
    ...
    $stt=$_GET['stt'];
        ...
        while($r=mysql_fetch_row($query)){
            mysql_query("insert into penjualan(id_penjualan,id_keranjang, id_distributor, id_darah, banyaknya, total, tanggal,status)
                        values ('$nomer','$r[0]', '$r[1]', '$r[2]', '$r[3]', '$r[4]', '$tanggal', '$stt')");
